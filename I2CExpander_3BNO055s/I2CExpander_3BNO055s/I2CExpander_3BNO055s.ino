/**
 * Arduino Sketch for Reading Orientation Data from Three BNO055 Sensors
 * via a TCA9548A I2C Multiplexer
 * 
 * Author: Dong Heon Han
 * 
 * This sketch demonstrates how to interface with three BNO055 sensors connected
 * to an Arduino through a TCA9548A I2C multiplexer. It reads orientation data
 * (X, Y, Z) from each sensor and prints it to the Serial Monitor.
 */
...
void printOrientation(sensors_vec_t orientation) {
  ...
  Serial.print("X: "); // Label for X-axis
  Serial.print(orientation.x); // Print X-axis value
  Serial.print(" Y: "); // Label for Y-axis
  Serial.print(orientation.y); // Print Y-axis value
  Serial.print(" Z: "); // Label for Z-axis
  Serial.println(orientation.z); // Print Z-axis value
}
